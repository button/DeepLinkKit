...
@class    DLCDeepLink;
@protocol DLCDeepLinkRouteHandler;
...
/**
 ...
 @see DLCDeepLinkRouteHandler
 */
typedef void(^DLCRouteHandlerBlock)(DLCDeepLink *deepLink);
...
@interface DLCDeepLinkRouter : NSObject
...
/**
 Registers a class conforming to the `DLCDeepLinkRouteHandler' protocol for a given route.
...
/**
 ...
 @code 
 deepLinkRouter[@"table/book/:id"] = ^(DLCDeepLink *deepLink) {
    // Handle the link here.
 };
 @endcode
 @note Registering a class conforming to `DLCDeepLinkRouteHandler' is the preferred method of route registration. 
